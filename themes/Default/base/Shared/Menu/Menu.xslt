...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template mode="MenuPost" match="li">
        ...
        <xsl:choose>
            <xsl:when
                    test="a = $menuBackTrack/Item[$count]/Name and tokenize(a/@class, '\s+') = $menuBackTrack/Item[$count]/LocalName">
                <xsl:copy>
                    <xsl:attribute name="class"
                                   select="concat(@class,' breadcrumbs ',$menuBackTrack/Item[$count]/ExtraClass)"/>
