...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="Table-head">
        ...
        <script type="text/javascript" src="{concat($prefix, 'base/Shared/Table/Table.js')}"></script>
        <script type="text/javascript" src="{concat($prefix, 'base/Shared/Table/sorttable.js')}"></script>
