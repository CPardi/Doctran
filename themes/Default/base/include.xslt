...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:include href="Project/Include-Project.xslt" />
	<xsl:include href="File/Include-File.xslt" />

	<xsl:include href="Shared/PreProcess.xslt" />
	<xsl:include href="Shared/AddDescription.xslt" />
	<xsl:include href="Shared/DescriptionCell.xslt" />
	<xsl:include href="Shared/AddSubObjectLists.xslt" />
	<xsl:include href="Shared/For.xslt" />
	<xsl:include href="Shared/RemoveRoot.xslt" />
	...
	<xsl:include href="Shared/List/List.xslt" />
	<xsl:include href="Shared/ListPage/ListPage.xslt" />
  ...
  <xsl:include href="Shared/Search/Search.xslt" />
	...
	<xsl:include href="Shared/Statistics/StatisticsList.xslt" />
	<xsl:include href="Shared/Statistics/CellFormat-Statistic.xslt" />
