// <copyright file="BlockEndTest.cs" company="Christopher Pardi">
...
namespace Doctran.Test.ParsingElements.FortranBlocks.NamedDescriptionBlock
{
    ...
    public class BlockEndTest
    {
        ...
        public void ValidDeclarations(string linesString, Action<IEnumerable<IFortranObject>> makeAssertions)
            => TestingUtils.BlockEndCheck(Block, new IFortranBlock[] { new SourceBlock("FreeFormatFortran") }, linesString);
    }
}