namespace Doctran.Test.ParsingElements.Scope.GlobalScope
{
    ...
    public class GetObjectFromIdentifierTest
    {
        ...
        {
            IHasIdentifier obj;
            Assert.IsTrue(Gs.GetObjectFromIdentifier(new CaseSensitiveId("Unit1"), out obj));
        ...
        {
            ScopingUnit2 obj;
            Assert.IsTrue(Gs.GetObjectFromIdentifier(new CaseSensitiveId("Unit2"), out obj));
        ...
        {
            ScopingUnit obj;
            Assert.IsFalse(Gs.GetObjectFromIdentifier(new CaseSensitiveId("Unit3"), out obj), "Found non-existing object 'Unit3'.");
        }
