            ...
            do
            {
                ...
                if (check_internal)
                {
                    ...
                    if (result_start.Found)
                    {
                        ...
                        blockSubObjects.AddRange(SearchBlock(pathAndFileName, lines, _blocks[result_start.BlockName].CheckInternal, result_start.Index, ref current_index, result_start.BlockName, block_name));
