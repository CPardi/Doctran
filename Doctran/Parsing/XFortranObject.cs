// <copyright file="XFortranObject.cs" company="Christopher Pardi">
...
namespace Doctran.Parsing
{
    ...
    public abstract class XFortranObject : FortranObject
    {
        ...
        protected XFortranObject(string xElementName, IEnumerable<IFortranObject> subObjects, List<FileLine> lines)
            : base(subObjects, lines)
        {
            this.XElementName = xElementName;
        }

        //      protected XFortranObject(string name, IEnumerable<IFortranObject> subObjects, string xElementName, List<FileLine> lines)
        //	: base(name, subObjects, lines)
        //{
        //	this.XElementName = xElementName;
        //}

        //private List<XElement> NonFortranObject(IFortranObject obj)
        //{
        //	var xeles = new List<XElement>();
        //	xeles.AddRange(GroupXEle(obj));
        //	xeles.AddRange(obj.SubObjectsNotOfType<XFortranObject>().SelectMany(NonFortranObject));
        //	return xeles;
        //}
